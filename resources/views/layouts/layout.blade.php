...
<head>
    ...
    <title>The Upwork - Dashboard</title>
...
<div id="app">
    <div id="wrapper">
        <!-- Sidebar  v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true "-->
        <nav id="sidebar"  style="display: flex">
            <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">The Task</div>
                </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <!-- TopBar -->
                <nav id="topbar"  style="display: flex" class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top">
            ...
            <span>copyright &copy; {{ date('Y') }} - developed by
              <b><a href="https://t.me/Lucky_boy" target="_blank">Bunyodbek</a></b>
            </span>
                    </div>
                </div>
            </footer>
